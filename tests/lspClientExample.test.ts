...
import * as lspClient from '../src/lspclient/mainLsp';
import {JSONRPCEndpoint, LspClient, SignatureHelpTriggerKind} from '../src/lspclient/mainLsp';
...
beforeAll(async () => {
  ...
  const processPid = process.pid === undefined ? null : process.pid;
