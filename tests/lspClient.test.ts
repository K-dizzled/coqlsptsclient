...
import { JSONRPCEndpoint } from "../src/lspclient/jsonRpcEndpoint";
import { LspClient } from "../src/lspclient/lspClient";
import { ClientCapabilities, DidCloseTextDocumentParams, DidOpenTextDocumentParams, DocumentSymbol, SymbolKind, Location, SignatureHelp } from "../src/lspclient/models";
...
describe('LspClient', () => {
    ...
    it('sends a LSP Initialized notification', async () => {
        ...
        const initializedNotification: JSONRPCRequest = { "jsonrpc": "2.0", "method": "initialized","params":{}};
